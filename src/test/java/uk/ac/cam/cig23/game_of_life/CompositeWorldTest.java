...
import static uk.ac.cam.cig23.game_of_life.WorldStringUtils.lines;
...
public class CompositeWorldTest {
  ...
  @Test
  public void withCellAliveness_doesNothingWhenOutOfRange() {
    // ARRANGE
    World compositeWorld =
            stringToWorld(
                    new CompositeWorld(2, 1),
                    ...
                    "________________");
    // ACT
    World next = compositeWorld.withCellAliveness(-1, -7, true);
  ...
  @Test
  public void withCellAliveness_willSetEitherTinyWorld() {
    // ARRANGE
    World compositeWorld =
            stringToWorld(
                    new CompositeWorld(2, 1),
                    ...
                    "________________");
    // ACT
    World next = compositeWorld.withCellAliveness(14, 0, true);
  ...
  @Test
  public void cellAlive_returnsTrueWhenCellIsAlive() {
    // ARRANGE
    World compositeWorld =
            stringToWorld(
                    new CompositeWorld(2, 1),
  ...
  @Test
  public void cellAlive_returnsFalseWhenCellIsOutOfRange() {
    // ARRANGE
    World compositeWorld =
            stringToWorld(
                    new CompositeWorld(2, 1),
  ...
  @Test
  public void withCellAliveness_doesntChangeOriginal() {
    // ARRANGE
    World compositeWorld =
            stringToWorld(
                    new CompositeWorld(2, 1),
    ...
    // ASSERT
    assertThat(worldToString(compositeWorld))
            .isEqualTo(
                    lines(
                            "________________",
                            "________________",
